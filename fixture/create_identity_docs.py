...
class CreateID:
    ...
    def create_docs(self):
        ...
        driver.find_element_by_xpath("(.//*[normalize-space(text()) and normalize-space(.)='Document Type'])[1]/following::div[4]").click()
        driver.implicitly_wait(20)
        driver.find_element_by_xpath("(.//*[normalize-space(text()) and normalize-space(.)='PASSPORT'])[1]/following::div[1]").click()
